...
import { Desk, Room, Toilet } from '../src/objects';
...
// Create objects
// const room1 = new Room('room1', { x: 50, y: 50 }, { width: 200, height: 150 }, '#FF5722');
// const room12 = new Room('room1', { x: 100, y: 100 }, { width: 200, height: 150 }, '#000');
const desk1 = new Desk('desk1', { x: 100, y: 250 }, { width: 150, height: 100 }, '#4CAF50', '#2196F3');
// const toilet1 = new Toilet('toilet1', { x: 500, y: 100 }, { width: 60, height: 60 }, '#2196F3');

// Add objects to floor map
// map.addObject(room12);
// map.addObject(room1);

map.addObject(desk1);
// map.addObject(toilet1);